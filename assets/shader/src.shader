  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d = dot(_TintColor.ww, float2(u_xlat0_d, u_xlat0_d)); // _TintColor.a + _TintColor.a

          u_xlat2.xy = ((float2(float2(_CustomMask, _CustomMask)) * in_f.texcoord1.zw) + in_f.texcoord.xy); // in_f.texcoord.xy
          ...
          u_xlat1_d.xy = ((float2(float2(_CustomUV, _CustomUV)) * u_xlat1_d.xy) + in_f.texcoord.xy); // in_f.texcoord.xy
